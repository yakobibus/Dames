...
namespace spc_dames
{
	...
	public:
		...
		void set(const unsigned int& manoury) { std::cout << "m("<<manoury<<") .. "; }
		void set(const unsigned int& y, const unsigned int& x, const unsigned int& manoury, char* const motif, Pion* pion);
		char* const getMotif(void) const { return _motif.getMotif(); }
